...
child_basenames:
- ufo_noises_37edd1_record_check_ufo_noi_a48df5_independent_witness_94dcb1
- ufo_noises_37edd1_record_check_ufo_noi_a48df5_index
...
show_ads: true
description: A careful recording, location notes, timing, and comparison checks can make an unusual sound report much more useful.
hero_summary: A careful recording, location notes, timing, and comparison checks can make an unusual sound report much more useful.
layout: default
permalink: /record-it/
...
page_heading_title: How Should You Record a UFO Noise?
source_count: 33
infographic_count: 3
planned_sections:
- What to capture immediately
- Useful notes and context
...
- basename: ufo_noises_37edd1_record_check_ufo_noi_a48df5_independent_witness_94dcb1
  title: Witness Notes | Record It
  permalink: /witness-notes/
  short_title: Witness Notes
...
next_link:
  ...
  heading_title: Can Sensors Catch UFO Noises?
header:
  og_image: /assets/images/ufo_noises_37edd1_record_check_ufo_noi_a48df5-overview-social.jpg
  preview_image: /assets/images/ufo_noises_37edd1_record_check_ufo_noi_a48df5-overview.webp
image: /assets/images/ufo_noises_37edd1_record_check_ufo_noi_a48df5-overview-social.jpg
---
...
* The sound itself using a phone, audio recorder or camera.
* The exact time, preferably down to the minute.
* Your location.
* The direction the sound appears to come from.
* Whether the sound is stationary, moving closer or moving away.
* Any visible lights, aircraft or unusual objects.
* Reactions from other witnesses nearby.

</div>

If possible, make a continuous recording rather than repeatedly starting and stopping. Continuous audio preserves changes in pitch, volume and rhythm that may help later identification.
...
* “It became louder at 22:14.”
* “A helicopter just appeared.”
...
Many mystery-sound investigations fail because the witness remembers the noise but not the circumstances.

A report becomes far more useful when it includes:
...
## How to Make a Better Recording

Most modern smartphones can capture useful evidence, but a few habits improve the result significantly.
...
Do not zoom in digitally or try to isolate only the mysterious sound.

Background noises can be extremely useful later because they provide reference points. Passing vehicles, birds, church bells or nearby conversations can help establish scale, direction and timing.

### Capture several minutes before and after

If the sound persists, continue recording even when nothing dramatic appears to be happening.

The beginning and ending phases often reveal clues. A supposed UFO hum may gradually resolve into a distant aircraft engine, industrial machine or drone once enough audio is collected.
...
Before assuming a UFO connection, compare the sound against known possibilities.

### Aircraft and helicopters

Aircraft remain one of the most common explanations for unusual aerial sounds.

Several factors can make ordinary aircraft seem strange:

* Temperature [inversions]({{ 'inversions/' | relative_url }}) can carry sound unexpectedly far.

<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Wind can change the apparent direction.
* Clouds can reflect sound.
* Large aircraft can produce deep, persistent hums.
* Helicopters can create rhythmic vibrations that seem unfamiliar at distance.
...
Many persistent hum reports eventually trace back to:
...
Strong winds, temperature layers and unusual atmospheric conditions can transport sounds over surprisingly large distances.

This is one reason why some witnesses hear what seems to be a nearby aerial source when the actual origin is many kilometres away.

## Looking at the Sound More Closely

If the recording is clear enough, free audio software can reveal patterns that are difficult to hear directly.
...
* Repeating pulses may suggest rotor blades.
* Broad noisy bands can indicate wind.
* Rapid frequency shifts may indicate a moving aircraft.
...
Several habits make unusual-sound reports much less useful.

### Recording only after the event

The most valuable evidence is captured while the sound is occurring.

A detailed memory recorded hours later is less reliable than a rough recording made immediately.

### Adding dramatic interpretations
...
Wind, rain, traffic and nearby machinery should always be noted.

A mystery sound cannot be evaluated properly without understanding the wider soundscape.

### Uploading only edited clips

Short, heavily processed clips often remove contextual clues.

Whenever possible, keep and share the original recording.

### Ignoring witness separation

If several people heard the sound, ask them to write independent descriptions before discussing it together.

Comparing independent accounts can reveal genuine consistencies and reduce the risk of shared memory effects.
...
* A clear recording exists.
* Exact time and location are known.
* Multiple independent witnesses heard the same thing.
* Weather conditions are documented.
* Flight activity and obvious local sources have been checked.
* The original audio remains available.
...
<a href="https://www.amazon.com/s?k=Practical+Recording+Techniques+Bruce+Bartlett&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
</a>
</div>
</div>
...
<article class="fr-book-card">
<a class="fr-book-cover" href="https://www.amazon.com/s?k=The+Location+Sound+Bible+Ric+Viers&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open The Location Sound Bible on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://books.google.com/books/content?id=EDeWtgAACAAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=1&amp;source=gbs_api" alt="Cover for The Location Sound Bible" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
<div class="fr-book-info">
<h4 class="fr-book-title">
<a href="https://www.amazon.com/s?k=The+Location+Sound+Bible+Ric+Viers&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="The Location Sound Bible">The Location Sound Bible</a>
</h4>
<p class="fr-book-author">By Ric Viers</p>
        
<p class="fr-book-desc">Explains practical outdoor recording methods and mistakes.</p>
<div class="fr-book-actions">
<a href="https://www.amazon.com/s?k=The+Location+Sound+Bible+Ric+Viers&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
</a>
</div>
</div>
...
<p class="fr-book-desc">Encourages rigorous evidence gathering and documentation.</p>
<div class="fr-book-actions">
...
<div class="fr-browse-links" aria-label="Browse more on Amazon"><span class="fr-browse-links-label">Browse more on Amazon:</span><a class="fr-browse-more" href="https://www.amazon.com/s?k=Practical+Recording+Techniques&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">Practical Recording Techniques</a><a class="fr-browse-more" href="https://www.amazon.com/s?k=The+Location+Sound+Bible&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">The Location Sound Bible</a><a class="fr-browse-more" href="https://www.amazon.com/s?k=Springer+of+Acoustics+books&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">Springer of Acoustics books</a></div>
